...
public class LrcController {
	...
	public LrcController(Activity paramActivity,
			AartiPlayerFragment paramAartiPlayerFragment) {
	...
	public void beginLrcPlay() {
		if (this.mTimer == null) {
			...
			this.mTimer.scheduleAtFixedRate(this.mTask, 0L,
					this.mPalyTimerDuration);
		}
	}

	public String getFromAssets(String fileName) {
		try {
			InputStreamReader inputReader = new InputStreamReader(mActivity
	...
	public List<LrcRow> initLrcBuilder() {
		String str = getFromAssets(this.mCurrentPlayingAarti.getmAartiName()
				+ "_" + this.mCurrentPlaying + "_" + "english.lrc");
		Log.d("Sahi;", "lrc:" + str);
	...
	class LrcTask extends TimerTask {
		...
		public void run() {
			...
			final long l = LrcController.this.mFragment
					.getMainActivityController().getCurrentPosition();
